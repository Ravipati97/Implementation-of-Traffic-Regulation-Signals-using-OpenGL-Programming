//Project Title: Implementation of Traffic Regulation Signals using OpenGL Programming
//Project Team: Tarun Kumar Ravipati, Venkata Pavan Karnati
//Instructions: 
//Please include the following library files in the linker/additional dependencies/input section in the properties-
//freeglutd.lib
//glew32d.lib
//assimp-vc140.mt.lib
//SOIL.lib
//Also include the following directories in the VC++ directories/include directories section in the properties as per your system paths.
// The following directories are as per my system requirements -
//C:\Program Files (x86)\glm
//C:\Program Files (x86)\Simple OpenGL Image Library\src
...
// function declarations for each functionality in the progran
void bus();
void road();
void signal();
void car();
...
void frontscreen(void)
{
	...
	glColor3f(1, 0, 0);
	drawstring(300.0, 320.0, 0.0, "Implementation of Traffic Regulation SIgnals using OpenGL Programming ");
	glColor3f(1, 0.1, 1);
...
void helpscreen()
{
	...
	glClear(GL_COLOR_BUFFER_BIT);
	glColor3f(1, 1, 1);
	drawstring(650.0, 700.0, 0.0, "Instructions");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 620.0, 0.0, "Red Signal                                                                    Mouse Left Click");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 540.0, 0.0, "Yellow Signal                                                        Mouse Right Click and hold");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 460.0, 0.0, "Green Signal                                                        Mouse Right Click and Release");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 380.0, 0.0, "Vehicles move from left to right                                        Press 'L' key");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 300.0, 0.0, "Vehicles move from right to left                                        Press 'R' key");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 220.0, 0.0, "Increases the speed of vehicles                                         Press 'S' key");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 140.0, 0.0, "Help                                                                                   Press 'H' key");
	glColor3f(0.5, 0.1, 0.9);
	drawstring(350.0, 60.0, 0.0, "Go to Interface screen                                                   Press 'Enter' key");
	glFlush();
}
